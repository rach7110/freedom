    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="project-description">
            <p>A single page app that demonstates interactive styling. It uses a homemade CSS grid to vary the column widths in the color swatch. It uses JQuery to assign CSS styling and property values in order to display matching colors and students. It also uses MVC architecture so users can view and add new students to the database.  And it uses HTML form validation.</p>
